...
async def test_handle_start():
    ...
    from knowledge_base.archive.old_outputs.telegram_bot import handle_start, MSG_START
...
def test_config_loading():
    ...
    from knowledge_base.archive.old_outputs.telegram_bot import BOT_TOKEN
    import os
