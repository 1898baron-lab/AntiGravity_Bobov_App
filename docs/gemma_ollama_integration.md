...
## 5. Локальный Ollama-прокси

Если нужно, можно запустить локальный прокси, который упрощает интеграцию в текущую систему и делает Gemma доступным по одному адресу.

```bash
python scripts/ollama_connector.py --port 11435
```

После запуска прокси доступен:

- `http://localhost:11435/health`
- `http://localhost:11435/api/generate`
- `http://localhost:11435/v1/chat/completions`

Если Ollama запущен не на стандартном адресе, укажите его явно:
